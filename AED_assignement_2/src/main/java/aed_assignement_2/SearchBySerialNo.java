 ...
 * @author gloriasingh
 */
public class SearchBySerialNo extends javax.swing.JFrame {

    /**
     * Creates new form SearchBySerialNo
     */
    
     DefaultTableModel model;
    ArrayList<CarsInfo> cars;
    public SearchBySerialNo() {
        initComponents();
...
{        
    try {
        ...
        for (int i = 0; i < data.size(); i++) 
        {
            ...
            if((row.getSerial_no())==(Integer.parseInt(jTextField1.getText().trim())))
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the Serial No");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "please enter the car's serial Number!");
            return;
        }
        else{
            manageTable();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchBySerialNo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
