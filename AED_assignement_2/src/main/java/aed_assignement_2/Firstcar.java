 ...
 * @author gloriasingh
 */
public class Firstcar extends javax.swing.JFrame {

    /**
     * Creates new form First car
     */
        ...
        public void manageTable()
{
    try {
        ...
        for (int i = 0; i < data.size(); i++) 
        {
            ...
            if(row.isAvailability()==true&&(row.getLocation().equalsIgnoreCase("Boston")))
            {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Firstcar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
