 ...
 * @author gloriasingh
 */
public class SearchByFleet extends javax.swing.JFrame {

    /**
     * Creates new form SearchByFleet
     */
    DefaultTableModel model;
    ArrayList<CarsInfo> cars;
    public SearchByFleet() {
        initComponents();
...
{        
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Click to see the last time the fleet catalog was updated for each car");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Company", "Location", "Serial No", "Last service date", "last fleet catalog", "availability"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchByFleet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
