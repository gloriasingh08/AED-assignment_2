 ...
 * @author gloriasingh
 */
public class CarUberComp extends javax.swing.JFrame {

    /**
     * Creates new form CarUberComp
     */
    ...
    public void manageTable()
{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter the company to see the list of cars manufactured by this car(uber)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarUberComp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
